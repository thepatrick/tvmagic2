...
- (NSString*)nameOfColumnAtIndex:(int)inIndex
{
	...
	return [NSString stringWithCString:mColumns[ inIndex ] encoding:NSStringEncodingConversionExternalRepresentation];
}
...
- (NSString*)stringForColumnAtIndex:(int)inIndex
{
	...
	return [NSString stringWithCString:mRowData[ inIndex ] encoding:NSStringEncodingConversionExternalRepresentation];
}
